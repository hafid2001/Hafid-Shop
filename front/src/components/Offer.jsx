...
const Offer = () => {
  ...
  const [products, setProducts] = useState(all_products.slice(0, 12)); // عرض أول 12 منتج

  // عداد تنازلي لعرض التخفيضات
  useEffect(() => {
    const targetDate = new Date();

    // عرض 5 أيام على سبيل المثال
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto text-center">
        ...
        <p className="text-gray-300 mb-12 text-lg sm:text-xl">
          اكتشف أحدث المنتجات واقتنم التخفيضات قبل انتهاء الوقت!
        </p>
        ...
        <div className="flex justify-center items-center gap-6 mb-16 text-center">
          {["days", "hours", "minutes", "seconds"].map((unit) => (
            ...
            >
              ...
              <span className="block text-gray-200 mt-2 capitalize">
                {unit}
              </span>
            </div>
          ))}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10">
          {products.map((product) => (
            ...
            >
              <div
                className="relative w-full h-64 flex items-center justify-center bg-gradient-to-b
