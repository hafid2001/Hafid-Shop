...
>
  <input
    ...
    required
    className="bg-white/10 p-4 rounded-xl font-semibold
    focus:outline-none focus:ring-2 text-black
    placeholder-gray-600 focus:ring-cyan-400 transition-all"
  />
  ...
  <textarea
    ...
    required
    rows={5}
    className="bg-white/10 p-4 rounded-xl text-black
    placeholder-gray-600 font-semibold focus:outline-none
    focus:ring-2 focus:ring-cyan-400 transition-all"
  ></textarea>
   <button  type="submit" className="  bg-gradient-to-r from-indigo-500 via-purple-600 to-pink-500 px-6 py-3 rounded-2xl font-semibold text-white hover:opacity-90 transition-all shadow-lg">
       ارسال رسالة 
   </button>
...
<footer className="mt-24 relative z-10 max-w-7xl mx-auto text-center text-gray-300">
  <p className="mb-4">
    © 2025 E-Commerce. جميع الحقوق محفوظة.
  </p>
